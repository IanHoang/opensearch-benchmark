...
class TaskExecutionActor(actor.BenchmarkActor):
    ...
    def receiveMsg_StartTaskLoop(self, msg, sender):
        ...
        workload.load_workload_plugins(self.cfg, self.workload_name)  # ignore return value in this context
...
class WorkloadPreparationActor(actor.BenchmarkActor):
    ...
    def receiveMsg_PrepareWorkload(self, msg, sender):
        ...
        _, _ = load_workload_plugins(self.cfg, self.workload.name, register_workload_processor=tpr.register_workload_processor,
                           force_update=True)
...
class Worker(actor.BenchmarkActor):
    ...
    def receiveMsg_StartWorker(self, msg, sender):
        ...
        if self.workload.has_plugins:
            _, _ = workload.load_workload_plugins(self.config, self.workload.name, runner.register_runner, scheduler.register_scheduler)
        self.drive()
